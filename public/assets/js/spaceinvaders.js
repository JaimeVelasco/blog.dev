...
function Game() {
    ...
    this.config = {
        ...
        bombMinVelocity: 30,
        bombMaxVelocity: 30,
        invaderInitialVelocity: 65,
        invaderAcceleration: 2.0,
...
Game.prototype.start = function() {
    ...
    //  Start the game loop.
    var game = this;
    this.intervalId = setInterval(function () { GameLoop(game);}, 500 / this.config.fps);
...
WelcomeState.prototype.draw = function(game, dt, ctx) {
    ...
    ctx.fillText("Hey! Theres nothing here, are you lost?", game.width / 2, game.height/2 - 50); 
    ctx.font="16px 'Lato', sans-serif";

    ctx.fillText("You can hit one of the links at the top of the page, or press the space bar and enjoy.", game.width /2, game.height/2); 
};
...
PlayState.prototype.draw = function(game, dt, ctx) {
    ...
    for(var i=0; i<this.bombs.length; i++) {
        var bomb = this.bombs[i];
        ctx.fillRect(bomb.x - 2, bomb.y - 2, 5, 8);
    }
